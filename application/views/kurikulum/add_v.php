...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="#">Tambah kurikulum</a></li>
  ...
  <div class="box">
    ...
    <div class="box-body">
      ...
      $atribut_form = array(
        ...
        echo form_open('kurikulum/add', $atribut_form);
      ?>
      <div class="col-md-12">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" name="nama_kurikulum" placeholder="Masukkan nama kurikulum">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3 control-label">Is Aktif</label>
            <div class="col-sm-9">
              <?php echo form_dropdown('is_aktif', array('y'=>'Aktif', 'n'=>'Tidak Aktif'), '', "class='form-control'"); ?>
            </div>
          </div>
        </div>
