  ...
  <div class="box">
    ...
    <div class="box-body">
      ...
      $atribut_form = array(
        ...
        echo form_open('jurusan/add', $atribut_form);
      ?>
      <div class="col-md-12">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" name="kd_jurusan" placeholder="Masukkan Kode jurusan">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3 control-label">Nama Jurusan</label> <div class="col-sm-9">
