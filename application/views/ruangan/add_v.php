  ...
  <div class="box">
    ...
    <div class="box-body">
      ...
      $atribut_form = array(
        ...
        echo form_open('ruangan/add', $atribut_form);
      ?>
      <div class="col-md-12">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" name="kd_ruangan" placeholder="Masukkan Kode Ruangan">
            </div>
          </div>
          <div class="form-group">
