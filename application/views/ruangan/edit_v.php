  ...
  <div class="box">
    ...
    <div class="box-body">
      ...
      $atribut_form = array(
        ...
        echo form_open('ruangan/update', $atribut_form);

        //echo form_hidden('id', $siswa['nis']);
        
      foreach($ruangan as $k0 => $v0) {
        $kd_ruangan       = $v0->kd_ruangan;
        $nama_ruangan     = $v0->nama_ruangan;
      }
      ?>
      <div class="col-md-12">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="text" readonly="" class="form-control" name="kd_ruangan" placeholder="Masukkan Kode Ruangan" value="<?php echo $kd_ruangan; ?>">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3 control-label">Nama Ruang</label>
            <div class="col-sm-9">
              <input type="text" class="form-control" name="nama_ruangan" placeholder="Masukkan Nama Ruangan" value="<?php echo $nama_ruangan; ?>">
            </div>
          </div>
        </div>
