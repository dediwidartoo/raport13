  ...
  <div class="box">
    ...
    <div class="box-body">
      ...
      $atribut_form = array(
        ...
        echo form_open('tahunakademik/update', $atribut_form);

        //echo form_hidden('id', $siswa['nis']);
        
      foreach($tahunakademik as $k0 => $v0) {
        $kd_tahunakademik   = $v0->kd_tahunakademik;
        $nama_tahunakademik   = $v0->nama_tahunakademik;
      ...
      <div class="col-md-12">
        <div class="col-md-6">
          ...
          <?php echo form_input(array('name' => 'kd_tahunakademik', 'value' => $kd_tahunakademik, 'type' => 'hidden')); ?>
          <div class="form-group">
            <label class="col-sm-3 control-label">Tahun Akademik</label>
            <div class="col-sm-9">
              <input type="text" readonly="" class="form-control" name="nama_tahunakademik" placeholder="Masukkan tahun akademik" value="<?php echo $nama_tahunakademik; ?>">
            </div>
          </div>
          <div class="form-group">
